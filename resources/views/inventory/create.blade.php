...
<head>
  ...
  <title>Tambah Barang - Sistem Manajemen Barang</title>
...
<body>
  ...
  <section class="hero">
    ...
    <div class="hero__content">
      ...
      <h1>Tambah Barang<br><em>Baru</em></h1>
      <p>Tambahkan item barang baru ke dalam sistem inventori dengan mudah.</p>
    </div>
  </section>
  ...
  <div class="main-layout">
    ...
    <aside class="sidebar">
      ...
      <div class="form-info">
        ...
        <p>Isi semua field yang bertanda <span style="color: #d32f2f;">*</span> (wajib diisi)</p>
        <p style="margin-top: 1rem; font-size: 0.9rem; color: #666;">Anda dapat menyimpan data barang baru dan akan otomatis terintegrasi dengan sistem inventori.</p>
      </div>
    </aside>
    ...
    <div class="content-area">
      ...
      <div class="form-card">
        ...
        <form action="{{ route('barang.store') }}" method="POST" enctype="multipart/form-data" x-data="{ fotoPreview: null }">
          @csrf
          ...
          <div class="form-section">
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <input type="text" name="kode" value="{{ old('kode') }}" placeholder="BRG-001" required
              ...
              <div class="form-group">
                ...
                <input type="text" name="nama" value="{{ old('nama') }}" placeholder="Nama barang" required
          ...
          <div class="form-section">
            ...
            <div class="form-grid">
              ...
              <div class="form-group">
                ...
                <input type="text" name="lokasi" value="{{ old('lokasi') }}" placeholder="Rak A1" required
          ...
          <div class="form-section">
            ...
            <div class="form-group">
              ...
              <textarea name="keterangan" rows="3" placeholder="Keterangan tambahan (opsional)"
                        class="@error('keterangan') form-error @enderror">{{ old('keterangan') }}</textarea>
          ...
          <div class="form-section">
            ...
            <div class="form-group">
              ...
              <label for="foto" class="file-upload-area">
                ...
                <p style="font-size: 0.9rem; color: #999;">JPG, PNG, atau WebP (Maksimal 2MB)</p>
            ...
            <!-- Preview -->
            <div x-show="fotoPreview" style="margin-top: 1rem;">
