...
<body>
  ...
  <section class="hero">
    ...
    <div class="hero__content">
      ...
      <h1>Selamat datang,<br><em>{{ Auth::user()->name }}!</em></h1>
  ...
  <div class="main-layout">
    ...
    <aside class="sidebar">
      ...
      <div class="filter-group">
        <a href="{{ route('barang.create') }}" class="filter-btn" style="background: #ff8557; border: none; display: block; text-align: center; text-decoration: none; color: white;">
          ➕ Tambah Barang
        </a>
      ...
      <div class="filter-group">
        <div class="filter-group__label">👤 Info Pengguna</div>
    ...
    <div class="content-area">
      ...
      <div class="table-card">
        ...
        <div style="padding: 1.5rem;">
          <div style="display: flex; gap: 1.5rem; margin-bottom: 1.5rem; padding-bottom: 1.5rem; border-bottom: 1px solid #eee;">
            <div style="font-size: 1.8rem;">📦</div>
            <div style="flex: 1;">
              <p style="margin: 0; font-weight: 600; color: #1a1a2e;">Barang baru ditambahkan</p>
              <p style="margin: 0.3rem 0; color: #666; font-size: 0.95rem;">Anda menambahkan item barang baru ke sistem</p>
              <p style="margin: 0.5rem 0; font-size: 0.85rem; color: #999;">2 jam lalu</p>
            </div>
          </div>
          ...
          <div style="display: flex; gap: 1.5rem; margin-bottom: 1.5rem; padding-bottom: 1.5rem; border-bottom: 1px solid #eee;">
            ...
            <div style="flex: 1;">
              <p style="margin: 0; font-weight: 600; color: #1a1a2e;">Stok rendah ditemukan</p>
              <p style="margin: 0.3rem 0; color: #666; font-size: 0.95rem;">Beberapa item barang memiliki stok di bawah 5 unit</p>
              <p style="margin: 0.5rem 0; font-size: 0.85rem; color: #999;">3 hari lalu</p>
            </div>
          </div>
          ...
          <div style="display: flex; gap: 1.5rem;">
            <div style="font-size: 1.8rem;">✅</div>
            <div style="flex: 1;">
              <p style="margin: 0; font-weight: 600; color: #1a1a2e;">Sinkronisasi data berhasil</p>
              <p style="margin: 0.3rem 0; color: #666; font-size: 0.95rem;">Data inventori telah tersinkronisasi dengan database utama</p>
              <p style="margin: 0.5rem 0; font-size: 0.85rem; color: #999;">1 minggu lalu</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="table-card" style="margin-top: 2rem;">
        ...
        <div style="padding: 1rem 2rem; border-top: 1px solid #ddd; font-size: 0.9rem; color: #666; text-align: right;">
          <a href="{{ route('barang.index') }}" style="color: #FF85BB; text-decoration: none; font-weight: 600;">Lihat Semua →</a>
        </div>
        @else
