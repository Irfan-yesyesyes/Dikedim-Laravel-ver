...
<div class="row mb-4">
    <div class="col-md-8">
        <h1 class="h3 mb-0"><i class="bi bi-pencil-square"></i> Edit Data Petugas</h1>
    </div>
...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('petugas.update', $petugas) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nip') is-invalid @enderror"
                               id="nip" name="nip" value="{{ old('nip', $petugas->nip) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('jabatan') is-invalid @enderror"
                            ...
                            <option value="Kepala Gudang" {{ old('jabatan', $petugas->jabatan) == 'Kepala Gudang' ? 'selected' : '' }}>Kepala Gudang</option>
                            <option value="Petugas Gudang" {{ old('jabatan', $petugas->jabatan) == 'Petugas Gudang' ? 'selected' : '' }}>Petugas Gudang</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('no_telepon') is-invalid @enderror"
                               id="no_telepon" name="no_telepon" value="{{ old('no_telepon', $petugas->no_telepon) }}"
                    ...
                    <div class="mb-3">
                        ...
                        @if($petugas->foto)
                            <div class="mb-2">
                                ...
                                <img src="{{ Storage::url($petugas->foto) }}" alt="Foto Profil" class="rounded" width="150" height="150">
                            </div>
                        @endif
                        ...
                        <small class="form-text text-muted">
                            Format: JPG, PNG | Ukuran maksimal: 2MB | Kosongkan jika tidak ingin mengubah foto
                        </small>
                        @error('foto')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
